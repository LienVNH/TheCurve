...
Let op: deze blog is geen medisch advies. Overleg bij vragen altijd met je eigen arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/sporten.png"),
  },
  {
    id: "2",
...
Let op: deze blog is geen medisch advies. Praat bij vragen over je voeding altijd met je eigen arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/voeding.png"),
  },
  {
    id: "3",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/hypo.png"),
  },
  {
    id: "4",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/hyper.png"),
  },
  {
    id: "5",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/ouders.png"),
  },
  {
    id: "6",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/vrienden.png"),
  },
  {
    id: "7",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/moeilijkedag.png"),
  },
  {
    id: "8",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/relatie.png"),
  },
  {
    id: "9",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`
    // image: require("../assets/posts/kamp.png"),
  },
  {
    id: "10",
...
Let op: deze blog is geen medisch advies. Praat bij twijfel altijd met je arts of diabetesverpleegkundige.`,
    // image: require("../assets/posts/school.png"),
  },
];
...
export default function PostDetail() {
  ...
  return (
    <ScrollView contentContainerStyle={globalStyles.container}>
      ...
      <Text style={globalStyles.container}>{post.content}</Text>
    </ScrollView>
  );
}
